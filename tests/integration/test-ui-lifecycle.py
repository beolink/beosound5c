...
Runs against a live kiosk via Chrome DevTools Protocol. Point it at either:
  - a device:  tests/integration/test-ui-lifecycle.py --host beosound5c-office.lan
...
def main():
    ...
    ap.add_argument("--host", default="beosound5c-office.lan")
    ...
    #   ssh -L 9222:localhost:9222 kirsten@beosound5c-office.lan -N
